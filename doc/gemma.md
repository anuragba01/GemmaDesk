...
The Python API of LiteRT-LM for **Linux and macOS** (Windows support is
upcoming). Features like **multi-modality** , **tools use** , and **GPU
...
![](https://ai.google.dev/static/edge/litert-lm/images/demo.gif)
